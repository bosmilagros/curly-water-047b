...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-water-047b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-water-047b
```

A live public deployment of this template is available at [https://curly-water-047b.templates.workers.dev](https://curly-water-047b.templates.workers.dev)
